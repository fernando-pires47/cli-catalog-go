...
Ask the user (1-10 questions to start):

to perform questions relevants to the context, like:
  ...
  And any more relevent questions, respecting the limit...
...
### 4. Define the feature slug

---

## Template: `docs/feature-sdd/<feature-slug>/spec.md`
