...
Go through `docs/feature-sdd/<feature-slug>/tasks.md`:
- [ ] All tasks marked done?
- [ ] Any blocked or partial?

### 2. Verify Acceptance Criteria

For each user story in `docs/feature-sdd/<feature-slug>/spec.md`:
...
From `docs/feature-sdd/<feature-slug>/spec.md` edge cases:
...
**Date**: [YYYY-MM-DD]
**Spec**: `docs/feature-sdd/<feature-slug>/spec.md`
