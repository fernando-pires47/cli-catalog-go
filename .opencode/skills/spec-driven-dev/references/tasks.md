...
### 1. Review Design
Read `docs/feature-sdd/<feature-slug>/design.md` before creating tasks.
...
## Template: `docs/feature-sdd/<feature-slug>/tasks.md`

```markdown
# [Feature] Tasks

**Design**: `docs/feature-sdd/<feature-slug>/design.md`
